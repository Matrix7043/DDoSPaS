        ...
        <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md animate-fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/50 mt-2 text-sm">Start protecting your APIs today</p>
                </div>
                ...
                <div className="card">
                    <form id="form-register" onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button id="btn-register-submit" type="submit" className="btn-primary w-full" disabled={loading}>
